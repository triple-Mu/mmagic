...
experiment_name = 'repvgg-unetv6-step3'
...
model = dict(
    ...
    # L1Loss, CharbonnierLoss, PSNRLoss, MSELoss, PSNR_AND_L1Loss
    # pixel_loss=dict(type='PSNRLoss'),
    pixel_loss=dict(type='PSNR_AND_L1Loss', loss_weights=[2.0, 1.0]),
    train_cfg=dict(),
    test_cfg=dict(),
